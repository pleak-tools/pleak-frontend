...
app.use('/sensitivities-editor/:id', express.static(__dirname + '/../' + config.sql_derivative_sensitivity_editor.folder + '/dist'));
app.use('/sensitivities-editor/viewer/:id', express.static(__dirname + '/../' + config.sql_derivative_sensitivity_editor.folder + '/dist'));
